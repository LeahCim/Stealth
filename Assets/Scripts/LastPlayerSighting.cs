...
public class LastPlayerSighting : MonoBehaviour
{
	...
	public Vector3 position;                                            // The last global sighting of the player.
	...
	public float musicFadeSpeed = 1f;                                   // As above but for music

	private AlarmLight alarm;                                           // Reference to the AlarmLight script.
	private Light mainLight;                                            // Reference to the main light.
	private AudioSource panicAudio;                                     // Reference to the AudioSource of the panic music.
